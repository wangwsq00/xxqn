...
3. 点击 **装备**：六部位槽位（空槽为占位）+ 背包木剑；穿上后攻击按公式提高
4. 点击 **进入试炼**
5. 可见双方各 5 个槽位（布局 4-2-1-3-5），**主角固定我方中间 1 号位**，对位 1–2 名敌人
6. 行动条自动充能，单位出手（有功法则按 1–4 槽释放，否则普通攻击），战斗会分出胜负
7. 首次胜利且尚未拥有木剑时，木剑掉入背包并写入存档
