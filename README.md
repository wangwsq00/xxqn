...
6. 点击 **进入试炼**
7. 可见双方各 5 个槽位（布局 4-2-1-3-5），**主角固定我方中间 1 号位**，对位 1–2 名敌人
8. 行动条自动充能，单位出手（有功法则按 1–4 槽释放，否则普通攻击），战斗会分出胜负
9. **试炼胜利**发放 50 灵石（失败无奖励），写入 LocalStorage；返回洞府可见钱包增加。若尚未拥有木剑，仍会掉入背包
